...
function PeriodNavigator({
  ...
  return (
    <div className="flex items-center gap-3 self-start sm:self-auto">
      {/* Date navigator */}
      <div className="flex items-center rounded-xl border border-border/60 bg-muted/80 shadow-sm p-1.5 gap-1">
        <Button
          variant="ghost"
          size="icon"
          className="h-9 w-9 rounded-lg text-muted-foreground hover:text-foreground hover:bg-background/60 transition-all"
          onClick={onPrev}
        >
          <ChevronLeft className="h-4 w-4" />
        </Button>

        <span className="font-medium capitalize text-sm min-w-[148px] text-center px-2 text-foreground/80 select-none">
          {periodLabel}
        </span>
        ...
        <Button
          variant="ghost"
          size="icon"
          className="h-9 w-9 rounded-lg text-muted-foreground hover:text-foreground hover:bg-background/60 transition-all disabled:opacity-30"
        ...
        <Button
          variant="ghost"
          size="sm"
          className={`text-sm h-9 px-3 rounded-lg transition-all ${
            isCurrentPeriod
      ...
      <div className="flex items-center rounded-xl border border-border/60 bg-muted/80 shadow-sm p-1.5 gap-1">
        <Button
          ...
          size="sm"
          className={`h-9 px-4 rounded-lg text-sm transition-all ${
